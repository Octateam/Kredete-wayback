...
export function RegionTabs({ platformId, versionId, regions }: RegionTabsProps) {
  return (
    <div className="flex w-fit shrink-0 items-center gap-1 rounded-full border border-neutral-200 bg-neutral-50 p-1 dark:border-neutral-800 dark:bg-neutral-900">
      {regions.map((region) => (
        <NavLink
          key={region.id}
